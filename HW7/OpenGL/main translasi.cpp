...
void display() {
    ...
    drawLine(1.0f, 3.0f, 6.0f, 8.0f); // Titik awal dan akhir dimodifikasi

    glColor3f(0.0f, 0.0f, 1.0f); // Warna biru

    // Garis setelah translasi
    drawLine(1.0f + translateX, 3.0f + translateY, 6.0f + translateX, 8.0f + translateY); // Titik awal dan akhir dimodifikasi
